...
const copy = {
    en: {
        ...
        inactiveOverrideBody: 'This invoice was generated from a non-active contract.',
        contractStatus: 'Contract status',
        overrideReason: 'Reason',
        signatureSection: 'Signature and Stamp',
        placeAndDate: 'Place and date',
        cachetStamp: 'Signature and stamp',
        missingTitle: 'Complete the required selections to preview this invoice',
    ...
    fr: {
        ...
        roomingList: 'Liste des chambres',
        pricingBreakdown: 'Détail des prix par nuit',
        ...
        lineModeNote: 'Montants par nuit avant remises séjour. Remises résumées ci-dessous.',
        inactiveOverrideTitle: 'Dérogation commerciale exceptionnelle',
        inactiveOverrideBody: 'Cette facture a été générée depuis un contrat non actif.',
        ...
        missingTitle: 'Complétez les sélections requises pour prévisualiser cette facture',
        missingBody: 'La facture sera générée dès que le contexte requis sera disponible.',
        missingFallback: 'Données de facture manquantes',
        requiredContext: 'Contexte requis',
        includedInSummary: 'Inclus dans le récapitulatif',
        years: 'ans',
    },
} as const;
