...
import TemplateEarlyBookingModal from '../components/TemplateEarlyBookingModal';
        ...
        <div className="p-8">
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-3">
                        ...
                        Catalogue Early Booking
                    </h1>
                    <p className="text-sm text-gray-500 mt-1">Définitions des offres de réservations anticipées (templates)</p>
                </div>
            ...
            {isError && (
                <div className="rounded-xl bg-red-50 border border-red-200 p-6 text-red-700 text-sm font-bold">
                    Impossible de charger le catalogue Early Booking.
                </div>
            )}
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    {archivedEarlyBookings.map((eb: any) => (
                                        <tr key={eb.id} className="hover:bg-gray-100 transition-colors">
                                            <td className="px-5 py-3 text-gray-500 font-bold">{eb.name}</td>
                                            <td className="px-5 py-3 text-center text-[10px] text-gray-400 font-mono italic">
