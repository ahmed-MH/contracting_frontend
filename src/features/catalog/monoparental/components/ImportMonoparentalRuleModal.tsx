        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/40 backdrop-blur-xs">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden flex flex-col max-h-[85vh]">
                ...
                <div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                    <div>
                        <h3 className="text-lg font-bold text-gray-900">Catalogue des Règles Monoparentales</h3>
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-xs text-gray-500 mt-1 flex items-center gap-2 flex-wrap">
                                            <span className="font-bold text-gray-700 bg-gray-100 px-1.5 py-0.5 rounded border border-gray-200">{t.adultCount}AD + {t.childCount}CH</span>
                                            <span>•</span>
                                            <span className="font-bold text-blue-700 bg-blue-50 px-1.5 py-0.5 rounded border border-blue-100">{BASE_RATE_LABELS[t.baseRateType]}</span>
                                            <span>•</span>
                                            <span className="font-mono text-gray-400">{t.minAge}–{t.maxAge} ans</span>
                                            <span>•</span>
                                            <span className="font-bold text-violet-700 bg-violet-50 px-1.5 py-0.5 rounded border border-violet-100">{CHILD_SURCHARGE_BASE_LABELS[t.childSurchargeBase]}</span>
                                            <span>•</span>
