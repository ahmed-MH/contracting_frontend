            ...
            <div className="space-y-6">
                    <div className="p-6 space-y-6 flex-1">
                        ...
                        <div className="bg-brand-mint/5 border border-brand-mint/20 rounded-xl p-4 flex gap-3 text-brand-slate shadow-sm">
                            <div className="bg-brand-mint p-1.5 rounded-xl h-fit text-white">
                                <FileText size={16} />
                            </div>
                        ...
                        {/* Info de base */}
                        <div className="bg-white dark:bg-brand-navy/30 p-4 rounded-xl border border-brand-slate/20">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="bg-brand-slate/10 p-4 rounded-xl border border-brand-slate/30">
                                    ...
                                    <select {...register('conditionType')}
                                        className="w-full mb-3 px-3 py-2 bg-white border border-brand-slate/30 rounded-xl text-sm focus:ring-2 focus:ring-brand-mint outline-none font-medium text-brand-navy dark:text-brand-navy">
                                    ...
                                    {conditionNeedsValue && (
                                        <div className="relative animate-in fade-in">
                                            <input type="number" min="0"
                                                ...
                                                className="w-full pl-9 pr-3 py-2 bg-white border border-brand-slate/30 rounded-xl text-sm focus:ring-2 focus:ring-brand-mint outline-none" />
                                ...
                                <div className="bg-brand-mint/5 p-4 rounded-xl border border-brand-mint/20">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="bg-white dark:bg-brand-navy/40 p-3 rounded-xl border border-brand-slate/20 shadow-sm">
                                            ...
                                            <div className="flex flex-col gap-2">
                                                ...
                                                <select {...register('applicationType')}
                                                    className="w-full px-3 py-2 bg-brand-mint text-white rounded-xl text-[10px] font-black uppercase tracking-tighter hover:bg-brand-mint/90 transition-colors cursor-pointer outline-none">
                                        ...
                                        <div className="flex flex-col justify-center">
                                            ...
                                            <input type="number" min="0" step="0.01" placeholder={t('auto.features.contracts.details.modals.editcontractspomodal.placeholder.40a06a0a', { defaultValue: "Valeur base" })}
                                                    ...
                                                    className="w-full pl-9 pr-3 py-3 bg-white border-2 border-brand-mint rounded-xl text-sm font-black text-brand-mint focus:ring-4 focus:ring-brand-mint/10 outline-none shadow-md" />
                                                ...
                                                <div className="grid grid-cols-2 gap-2 animate-in fade-in slide-in-from-right-2 duration-300">
                                                    <div className="relative">
                                                        <input
                                                            ...
                                                            className="w-full pl-2 pr-2 py-2 bg-white border border-brand-slate/20 rounded-xl text-sm focus:ring-2 focus:ring-brand-mint outline-none text-center font-bold"
                                                        />
                                                    </div>
                                                    <div className="relative">
                                                        <input
                        ...
                        {/* Ciblage (Targeting) */}
                        <div className="border border-brand-slate/20 rounded-xl overflow-hidden p-5 bg-white dark:bg-brand-navy/30 shadow-sm">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-1.5 max-h-48 overflow-y-auto border border-brand-slate/20 rounded-xl p-3 bg-brand-light/50 dark:bg-brand-slate/10">
                                        {contract.contractRooms?.map((r) => (
                                            <label key={r.id} className="flex items-center gap-3 text-sm cursor-pointer hover:bg-white dark:hover:bg-brand-slate/10 p-1.5 rounded-xl border border-transparent hover:border-brand-slate/15 transition-all">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-1.5 max-h-48 overflow-y-auto border border-brand-slate/20 rounded-xl p-3 bg-brand-light/50 dark:bg-brand-slate/10">
                                        {arrangements.map((a: Arrangement) => (
                                            <label key={a.id} className="flex items-center gap-3 text-sm cursor-pointer hover:bg-white dark:hover:bg-brand-slate/10 p-1.5 rounded-xl border border-transparent hover:border-brand-slate/15 transition-all">
                                                <input
                                                    type="checkbox"
                                                    value={a.id}
